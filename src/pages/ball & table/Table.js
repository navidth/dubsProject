...
import { posts,ItemMenu,Table_Ball } from '../../components/Data.js';
...
//   change page posts.....................................
   const paginate = (NumberPage)=>{
    ...
    <main className='mt-5 d-flex container-md'>
        ...
        <ArticleFilter>
        <Moshavere></Moshavere>
        <Resultcat names={Table_Ball} pageFather={ItemMenu.name[2]}></Resultcat>
        <PriceRange></PriceRange>
        </ArticleFilter>
        {/* .................Section Main Product.......... */}
        <SectionAllPrudoct>
         <Header pageName= "میز پینگ پنگ" pageFather={ItemMenu.name[2]}></Header>
         <Sortby></Sortby>
         <SectionProduct>
