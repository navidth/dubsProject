...
import { posts,ItemMenu,itemNamesRubbers } from '../../components/Data.js';
...
//   change page posts.....................................
   const paginate = (NumberPage)=>{
    ...
    <main className='mt-5 d-flex container-md'>
        ...
        <ArticleFilter>
        <Moshavere></Moshavere>
        <Resultcat names={itemNamesRubbers} pageFather={ItemMenu[1]}></Resultcat>
        <PriceRange></PriceRange>
        </ArticleFilter>
        {/* .................Section Main Product.......... */}
        <SectionAllPrudoct>
         <Header pageName= "رویه راکت باترفلای" pageFather={ItemMenu[1]}></Header>
         <Sortby></Sortby>
         <SectionProduct>
...
export default RubbersButterfly